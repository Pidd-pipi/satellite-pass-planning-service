...
var passRuleDefinitions = []PassRule{
	{Code: "PASS-0101", Name: "north ridge antenna duty", Severity: "high", AppliesTo: "North Ridge", MaxMinutes: 999},
	{Code: "PASS-0102", Name: "west mesa uplink power", Severity: "critical", AppliesTo: "West Mesa", MaxMinutes: 60},
	{Code: "PASS-0103", Name: "east yard scheduling", Severity: "normal", AppliesTo: "East Yard", MaxMinutes: 999},
	{Code: "PASS-0104", Name: "south loop receive", Severity: "low", AppliesTo: "South Loup", MaxMinutes: 90},
}
